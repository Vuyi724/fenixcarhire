      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden sticky top-6 border border-blue-100">
              <img
                src={car.image_url}
                ...
                <>
                  ...
                  <form className="space-y-6">
                    ...
                    <div className="border-t border-blue-200 pt-6">
                      <h3 className="text-lg font-semibold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent mb-4">Rental Details</h3>
              ...
              {paymentStep === 'confirmation' && (
                <>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-gray-50 rounded-lg p-6 mb-6 border border-blue-100">
                    <h3 className="font-semibold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent mb-4">Booking Summary</h3>
                    <div className="space-y-2 text-sm">
                      <p>
                        <span className="text-gray-600">Car:</span>
                        <span className="font-semibold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent"> {car.brand} {car.model}</span>
                      </p>
                      <p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <Link
                      href="/cars"
                      className="flex-1 border border-blue-200 text-blue-600 py-3 rounded-lg font-semibold hover:bg-blue-50 transition text-center"
                    >
                      Book Another Car
                    </Link>
                  </div>
