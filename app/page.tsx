...
export default function Home() {
  ...
  return (
    <main className="bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#fleet" className="text-gray-700 font-medium hover:text-blue-600 transition">Fleet</a>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
        {/* Carousel */}
      ...
      {/* About Section */}
      <section id="about" className="py-24 px-6 bg-gradient-to-r from-gray-50 to-white">
      ...
      <footer className="bg-gray-900 text-gray-300 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            {/* Company Info */}
            <div>
              <h3 className="text-2xl font-bold text-white mb-4">Fenix Car Hire</h3>
              <p className="text-gray-400 mb-4 leading-relaxed">
                Your trusted partner for reliable car rentals in Eswatini. Quality vehicles, exceptional service.
              </p>
              <div className="flex gap-4">
                <a href="https://www.facebook.com/profile.php?id=61585823326473" target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-blue-600 p-2 rounded-lg transition">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://wa.me/26876829797" target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-green-600 p-2 rounded-lg transition">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#fleet" className="text-gray-400 hover:text-white transition">Our Fleet</a></li>
                <li><a href="#services" className="text-gray-400 hover:text-white transition">Services</a></li>
                <li><a href="#contact" className="text-gray-400 hover:text-white transition">Contact</a></li>
                <li><Link href="/login" className="text-gray-400 hover:text-white transition">Book Now</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><span className="text-gray-400">Self-Drive Rentals</span></li>
                <li><span className="text-gray-400">Chauffeur Service</span></li>
                <li><span className="text-gray-400">Airport Transfers</span></li>
                <li><span className="text-gray-400">Corporate Packages</span></li>
                <li><span className="text-gray-400">Wedding Cars</span></li>
                <li><span className="text-gray-400">Long-Term Hire</span></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 mt-0.5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  <span className="text-gray-400">Sidwashini, Mbabane, Eswatini</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 mt-0.5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                ...
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 mt-0.5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                  <a href="mailto:reception@fenix.co.sz" className="text-gray-400 hover:text-white transition">reception@fenix.co.sz</a>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 mt-0.5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 2m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-gray-500 text-sm">&copy; 2026 Fenix Car Hire. All rights reserved.</p>
              <p className="text-gray-500 text-sm">Designed with passion for your rental experience</p>
            </div>
          </div>
        </div>
      </footer>
